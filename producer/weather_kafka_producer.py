...
# Kleiner Test-Grid mit 2 Punkten:
# GRID_PATH = "test_grid.csv"
# Für das volle Grid später z. B.:
GRID_PATH = "de_grid_cell_centers.csv"
...
while True:
    ...
    # Genau 1 Stunde warten, dann neuen Forecast ziehen
    time.sleep(3600)
